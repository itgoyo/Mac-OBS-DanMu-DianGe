  ...
  renderNotice: function() {
    function content() {
      return createElement('ul', null,
        ...
        // createElement('li', null, '键盘：Cherry G80-3000 IKBC Poker II；'),
        // createElement('li', null, '眼贴/药水：好视力眼贴、santen 参天 FXNEO、santen 参天 beautyeye；'),
        // createElement('li', null, '膏药：万通筋骨贴；')

        createElement('li', null, '[直播内容]'),
        createElement('li', null, '->'),
        createElement('li', null, 'C C++ Android'),
        createElement('li', null, '[开发必备]'),
        createElement('li', null, '->'),
        createElement('li', null, '系统：Mac OS'),
        createElement('li', null, '鼠标：Sunsonny；'),
        createElement('li', null, '键盘：Cherry G80-3000 IKBC Poker II；'),
        createElement('li', null, '[摄像头]'),
        createElement('li', null, '->'),
        createElement('li', null, '1080P 罗技C920'),
        createElement('li', null, '720P 甜甜圈'),
        createElement('li', null, '[麦克风]'),
        createElement('li', null, '->'),
        createElement('li', null, 'Blue nessie'),
